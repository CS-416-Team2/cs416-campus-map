...
const HAMMOND_BUILDINGS: Array<{
  ...
  { keys: ["SULB", "STUDENT UNION LIBRARY", "STUDENT UNION AND LIBRARY"], coords: [-87.47405943905542, 41.58431273705677] },
  { keys: ["NILS", "BIOSCIENCE", "NILS K. NELSON BIOSCIENCE INNOVATION BUILDING"], coords: [-87.47410915485779, 41.58350941743952] },

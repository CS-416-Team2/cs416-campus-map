...
import { CalendarDays, Clock, MapPin, CheckCircle, Circle, Loader2 } from "lucide-react";
...
function safeBadgeVariant(cat: string): "orange" | "green" | "blue" {
  return (categoryBadgeVariant as Record<string, "orange" | "green" | "blue">)[cat] ?? "blue";
}
...
export default function SchedulePage() {
  ...
  useEffect(() => {
    ...
    supabase
      .from("registrations")
      .select("id, event_id, status, events(id, title, date, time, location, category, capacity, registered)")
